...
static int sqlite3WalOpen(
  ...
  */
  ...
  if( rc!=SQLITE_OK ){
    ...
    out->methods.xLimit = (void (*)(void *, long long))sqlite3WalLimit;
    out->methods.xBeginReadTransaction = (int (*)(void *, int *))sqlite3WalBeginReadTransaction;
    out->methods.xEndReadTransaction = (void (*)(void *))sqlite3WalEndReadTransaction;
    out->methods.xFindFrame = (int (*)(void *, unsigned int, unsigned int *))sqlite3WalFindFrame;
    out->methods.xReadFrame = (int (*)(void *, unsigned int, int, unsigned char *))sqlite3WalReadFrame;
    out->methods.xDbsize = (unsigned int (*)(void *))sqlite3WalDbsize;
    out->methods.xBeginWriteTransaction = (int (*)(void *))sqlite3WalBeginWriteTransaction;
    out->methods.xEndWriteTransaction = (int (*)(void *))sqlite3WalEndWriteTransaction;
    out->methods.xUndo = (int (*)(void *, int (*)(void *, unsigned int), void *))sqlite3WalUndo;
    out->methods.xSavepoint = (void (*)(void *, unsigned int *))sqlite3WalSavepoint;
    out->methods.xSavepointUndo = (int (*)(void *, unsigned int *))sqlite3WalSavepointUndo;
    out->methods.xFrames = (int (*)(void *, int, libsql_pghdr *, unsigned int, int, int))sqlite3WalFrames;
    out->methods.xCheckpoint = (int (*)(void *, sqlite3 *, int, int (*)(void *), void *, int, int, unsigned char *, int *, int *))sqlite3WalCheckpoint;
    out->methods.xCallback = (int (*)(void *))sqlite3WalCallback;
    out->methods.xExclusiveMode = (int (*)(void *, int))sqlite3WalExclusiveMode;
    out->methods.xHeapMemory = (int (*)(void *))sqlite3WalHeapMemory;
#ifdef SQLITE_ENABLE_SNAPSHOT
    ...
    out->methods.xFile = (sqlite3_file *(*)(void *))sqlite3WalFile;

#ifdef SQLITE_ENABLE_SETLK_TIMEOUT
    methods.xWriteLock = sqlite3WalWriteLock;
#endif
    out->methods.xDb = (void (*)(void *, sqlite3 *))sqlite3WalDb;
...
int sqlite3DestroyCreateWal(void *self) {
    return SQLITE_OK;
}

libsql_create_wal sqlite3_create_wal = {
    .self = NULL,
    .xOpen = (int (*)(void *, sqlite3_vfs *, sqlite3_file *, int, long long, const char*, libsql_wal *))sqlite3WalOpen,
    .xClose = (int (*)(void *, void *, sqlite3 *, int, int, unsigned char *))sqlite3WalClose,
    .xPreMainDbOpen = NULL,
    .bUsesShm = 1,
    .xLogDestroy = (int (*)(void *, sqlite3_vfs*, const char*))sqlite3LogDestroy,
    .xLogExists = (int (*)(void *, sqlite3_vfs*, const char*, int *))sqlite3LogExists,
    .xDestroy =(int (*)(void*))sqlite3DestroyCreateWal,
};
